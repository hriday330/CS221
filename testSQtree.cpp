...
TEST_CASE("sqtree::basic copy","[weight=1][part=sqtree]"){
    ...
    //PNG origOut = t1.render();
    //out.writeToFile("images/soln/colourTest.png");
    //REQUIRE(t1.size() == t1copy.size());
    //REQUIRE(out == origOut);
    REQUIRE(out==img);
}
...
TEST_CASE("sqtree::tolerance construction and render","[weight=1][part=sqtree]"){
    ...
    // REMOVE FOR TESTING
    //result.writeToFile("images/soln/rb4000Test.png");
...
TEST_CASE("sqtree::big tolerance construction and render","[weight=1][part=sqtree]"){
    ...
    // REMOVE FOR TESTING
    //result.writeToFile("images/soln/van5590test.png");
